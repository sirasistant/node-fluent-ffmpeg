...
module.exports = function(proto) {
   ...
   * Specify GOP length
   *
   * @method FfmpegCommand#gopLength
   * @category Video
   * @aliases withOutputGopLength,withOutputGOPLength,gopLength,GOPLength
   *
   * @param {Number} fps output FPS
   * @return FfmpegCommand
   */
  proto.withOutputGopLength =
  proto.withOutputGOPLength =
  proto.gopLength =
  proto.GOPLength = function(frames) {
    this._currentOutput.video('-g', frames);
    return this;
  };
